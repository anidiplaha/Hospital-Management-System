...
def lst_doc():
    ...
    l=["Dr. Sk. Md. Hossin","Dr. Bhaskar Pal","Dr. Sushmita Chakraborty Das","Dr. Rahul Khan","Dr. Sangita Das","Dr. Prashanta Dhara","Dr. Sangita Sarkar","Dr. Sourav Pal","Dr. Moumita Das","Dr. Subhash Das",'Dr. Sipra Roy','Dr. Sourav Porel',
       'Dr. Anusree Maity','Dr. Abhijit Pal']
...
root=Tk()
label=Label(root,text="LUCIFER HOSPITAL HOWRAH",font="arial 40 bold",bg='light blue')
